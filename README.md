...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-sequences@v0.4.1-deno/mod.js';
```
...
[@stdlib/math/iter/sequences/tribonacci]: https://github.com/stdlib-js/math-iter-sequences-tribonacci/tree/deno
