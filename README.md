...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-sequences@v0.4.0-umd/browser.js' )
```
...
[@stdlib/math/iter/sequences/tribonacci]: https://github.com/stdlib-js/math-iter-sequences-tribonacci/tree/umd
