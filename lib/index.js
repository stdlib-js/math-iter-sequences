...
*/
setReadOnly( ns, 'iterContinuedFractionSeq', require( '@stdlib/math-iter-sequences-continued-fraction' ) );
...
*/
setReadOnly( ns, 'iterTribonacciSeq', require( '@stdlib/math-iter-sequences-tribonacci' ) );
